...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xmovie-feedstock/blob/master/LICENSE.txt)

Summary: A simple way of creating movies from xarray objects

Development: https://github.com/jbusecke/xmovie
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12452&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xmovie-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xmovie` can be installed with:

```
conda install xmovie
```

It is possible to list all of the versions of `xmovie` available on your platform with:
